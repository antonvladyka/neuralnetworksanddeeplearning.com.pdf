...
\begin{center}
	\includegraphics[width=0.5\textwidth]{./figures/ch1/mnist_100_digits.png}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.5]{./figures/ch1/tikz0.png}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.5]{./figures/ch1/tikz1.png}
\end{center}	
...
\begin{center}
	\includegraphics[scale=0.5]{./figures/ch1/tikz2.png}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.5]{./figures/ch1/tikz3.png}
\end{center}	
...
\begin{center}
	\includegraphics[scale=0.5]{./figures/ch1/tikz4.png}
\end{center}	
...
\begin{center}
	\includegraphics[scale=0.5]{./figures/ch1/tikz5.png}
\end{center}		
...
\begin{center}
	\includegraphics[scale=0.5]{./figures/ch1/tikz6.png}
\end{center}		
This notation for input perceptrons, in which we have an output, but no inputs,
\begin{center}
	\includegraphics[scale=0.5]{./figures/ch1/tikz7.png}
\end{center}	
...
\begin{center}
	\includegraphics[scale=0.5]{./figures/ch1/tikz8.png}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.5]{./figures/ch1/tikz9.png}
\end{center}	
...
\begin{center}
	\includegraphics[scale=0.5]{./figures/ch1/tikz10.png}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.5]{./figures/ch1/tikz11.png}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.25]{./figures/ch1/digits.png}
\end{center}
into six separate images,
\begin{center}
	\includegraphics[scale=0.35]{./figures/ch1/digits_separate.png}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.65]{./figures/ch1/mnist_first_digit.png}
\end{center}
is a 5.
...
\begin{center}
	\includegraphics[width=\linewidth]{./figures/ch1/tikz12.png}
\end{center}
...
\begin{center}
	\includegraphics[height=0.1\linewidth]{./figures/ch1/mnist_top_left_feature.png}
\end{center}
...
\begin{center}
	\includegraphics[height=0.1\linewidth]{./figures/ch1/mnist_other_features.png}
\end{center}
As you may have guessed, these four images together make up the 0 image that we saw in the line of digits shown earlier:
\begin{center}
	\includegraphics[height=0.1\linewidth]{./figures/ch1/mnist_complete_zero.png}
\end{center}
...
\begin{exercize}{Exercise}
	...
	\begin{center}
		\includegraphics[width=\linewidth]{./figures/ch1/tikz13.png}
	\end{center}
\end{exercize}
...
\begin{center}
	\includegraphics[scale=0.4]{./figures/ch1/digits_separate.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.5\linewidth]{./figures/ch1/valley.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.55\linewidth]{./figures/ch1/valley_with_ball.png}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.18]{./figures/ch1/mnist_2_and_1.png}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.35]{./figures/ch1/mnist_really_bad_images.png}
\end{center}
...
\begin{figure}
	\resizebox{\linewidth}{!}{
		\includegraphics[height=3cm]{./figures/ch1/File_Kangaroo_ST_03.jpg}
		\includegraphics[height=3cm]{./figures/ch1/Einstein_crop.jpg}
		\includegraphics[height=3cm]{./figures/ch1/hubble.jpg}
	}
...
\begin{center}
	\includegraphics[width=\linewidth]{./figures/ch1/tikz14.png}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.5]{./figures/ch1/tikz15.png}
\end{center}
