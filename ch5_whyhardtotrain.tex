...
\begin{center}
	\includegraphics[width=0.7\linewidth]{figures/ch5/shallow_circuit.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.7\linewidth]{figures/ch5/circuit_multiplication.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.6\linewidth]{figures/ch5/tikz35.png}
\end{center}
...
\begin{center}
	\includegraphics[width=\linewidth]{figures/ch5/tikz36.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.45\linewidth]{figures/ch5/tikz500.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.7\linewidth]{figures/ch5/training_speed_2_layers.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.7\linewidth]{figures/ch5/training_speed_3_layers.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.7\linewidth]{figures/ch5/training_speed_4_layers.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.7\linewidth]{figures/ch5/tikz37.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.7\linewidth]{figures/ch5/tikz38.png}
\end{center}
...
\begin{center}
	\includegraphics[width=0.7\linewidth]{figures/ch5/tikz39.png}
\end{center}
...
%	2|w|ln(|w|(1+1-4/|w|--------√)2-1).(123)
	\frac2{|w|}\ln\left(\frac{|w|(1+\sqrt{1-4/|w|})}{2}-1\right).\tag{123}\label{eq:123}
\end{equation}
...
\begin{center}
	\includegraphics[width=\linewidth]{figures/ch5/tikz40.png}
\end{center}
