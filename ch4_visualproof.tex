...
\begin{center}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)}, grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},zlabel={Output},title={$w_1=8,b=-8$},zmin=0,zmax=1]
			\addplot3[surf, domain=0:1,samples=26,shader=faceted]{1/(1+exp(-(8*x-8)))};
			\end{axis}
	\end{tikzpicture}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},title={$w_1=8,b=-5$},zmin=0,zmax=1]
			\addplot3[surf, domain=0:1,samples=26,shader=faceted]{1/(1+exp(-(8*x-5)))};
		\end{axis}
	\end{tikzpicture}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},title={$w_1=8,b=-2$},zmin=0,zmax=1]
...
\begin{center}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},zlabel={Output},title={$w_1=11,b=-5$},zmin=0,zmax=1]
	...
	\end{tikzpicture}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},title={$w_1=5,b=-5$},zmin=0,zmax=1]
...
\begin{center}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},zlabel={Output},title={$s_x=0.25$},zmin=0,zmax=1]
			\addplot3[surf, domain=0:1,samples=26,shader=faceted]{1/(1+exp(-1000*(x-0.25)))};
			\end{axis}
	\end{tikzpicture}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},title={$s_x=0.5$},zmin=0,zmax=1]
			\addplot3[surf, domain=0:1,samples=26,shader=faceted]{1/(1+exp(-1000*(x-0.5)))};
		\end{axis}
	\end{tikzpicture}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},title={$s_x=0.7$},zmin=0,zmax=1]
...
\begin{center}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},zlabel={Output},title={$s_y=0.25$},zmin=0,zmax=1]
			\addplot3[surf, domain=0:1,samples=26,shader=faceted]{1/(1+exp(-1000*(y-0.25)))};
			\end{axis}
	\end{tikzpicture}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},title={$s_y=0.5$},zmin=0,zmax=1]
			\addplot3[surf, domain=0:1,samples=26,shader=faceted]{1/(1+exp(-1000*(y-0.5)))};
		\end{axis}
	\end{tikzpicture}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},title={$s_y=0.7$},zmin=0,zmax=1]
...
\begin{center}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},zlabel={Output},title={$s^1_x=0.25,s^2_x=0.75, h=1$},zmin=0,zmax=1]
			\addplot3[surf, domain=0:1,samples=26,shader=faceted]{1/(1+exp(-100*(x-0.25)))-1/(1+exp(-100*(x-0.75)))};
			\end{axis}
	\end{tikzpicture}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},title={$s^1_x=0.25,s^2_x=0.75, h=0.75$},zmin=0,zmax=1]
			\addplot3[surf, domain=0:1,samples=26,shader=faceted]{0.75/(1+exp(-100*(x-0.25)))-0.75/(1+exp(-100*(x-0.75)))};
		\end{axis}
	\end{tikzpicture}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},title={$s^1_x=0.5,s^2_x=0.75, h=1$},zmin=0,zmax=1]
...
\begin{center}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},zlabel={Output},title={$s^1_y=0.25,s^2_y=0.75, h=1$},zmin=0,zmax=1]
			\addplot3[surf, domain=0:1,samples=26,shader=faceted]{1/(1+exp(-100*(y-0.25)))-1/(1+exp(-100*(y-0.75)))};
			\end{axis}
	\end{tikzpicture}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},title={$s^1_y=0.25,s^2_y=0.75, h=0.75$},zmin=0,zmax=1]
			\addplot3[surf, domain=0:1,samples=26,shader=faceted]{0.75/(1+exp(-100*(y-0.25)))-0.75/(1+exp(-100*(y-0.75)))};
		\end{axis}
	\end{tikzpicture}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},title={$s^1_y=0.25,s^2_y=0.45, h=0.8$},zmin=0,zmax=1]
...
\begin{center}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},zlabel={Output},title={$s^1_x=0.4,s^2_x=0.6,s^1_y=0.3,s^2_y=0.7, h=0.5$},zmin=0,zmax=1]
	...
	\end{tikzpicture}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},title={$s^1_x=0.4,s^2_x=0.6,s^1_y=0.3,s^2_y=0.7, h=1$},zmin=0,zmax=1]
...
\begin{center}
	\begin{tikzpicture}[scale=0.8]
			\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},zlabel={Output},title={Tower function},zmin=0,zmax=1]
				\addplot3[surf, domain=0:1,samples=41,shader=faceted]{(1/(1+exp(-100*(y-0.4)))-1/(1+exp(-100*(y-0.6))))*(1/(1+exp(-100*(x-0.4)))-1/(1+exp(-100*(x-0.6))))};
				\end{axis}
		\end{tikzpicture}
\end{center}
%
...
%x=1y=1Output
%
%With our initial parameters, the output looks like a flattened version of the earlier diagram, with its tower and plateau. To get the desired behaviour, we increase the parameter h until it becomes large. That gives the if-then-else thresholding behaviour. Second, to get the threshold right, we'll choose b≈-3h/2. Try it, and see how it works!
%
...
%
%Let's try three variables x1,x2,x3. The following network can be used to compute a tower function in four dimensions:
%
%
%Here, the x1,x2,x3 denote inputs to the network. The s1,t1 and so on are step points for neurons - that is, all the weights in the first layer are large, and the biases are set to give the step points s1,t1,s2,$\ldots$. The weights in the second layer alternate +h,-h, where h is some very large number. And the output bias is -5h/2.
%
%This network computes a function which is 1 provided three conditions are met: x1 is between s1 and t1; x2 is between s2 and t2; and x3 is between s3 and t3. The network is 0 everywhere else. That is, it's a kind of tower which is 1 in a little region of input space, and 0 everywhere else.
%
