...
\begin{center}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},zlabel={Output},title={$s^1_x=0.4,s^2_x=0.6,s^1_y=0.3,s^2_y=0.7, h=1$},zmin=0,zmax=1]
	...
	\end{tikzpicture}
	\begin{tikzpicture}[scale=0.8]
		\begin{axis}[colormap={justred}{rgb255=(255,127,127);rgb255=(127,31,31)},grid=major,width=0.40\linewidth,height=0.45\linewidth,view={-15}{10},xlabel={$x$},ylabel={$y$},title={$s^1_x=0.4,s^2_x=0.6,s^1_y=0.3,s^2_y=0.7, h=0.5$},zmin=0,zmax=1]
