...
\begin{center}
	\includegraphics[width=0.32\linewidth]{figures/ch4/tikz406}
	\begin{tikzpicture}[declare function = {bump(\x,\s,\t,\h)=0.5*\h*(sign(\x-\s)-sign(\x-\t));}]
	\begin{axis}[width=0.32\linewidth,height=0.3\linewidth,align=center,title={Weighted output\\$s_1=0.4,s_2=0.6,h=0.6$},axis x line=middle,axis y line=middle,xtick={0,1},ytick={-1,0,1},xmax=1.25,ymax=1.25,ymin=-1.25,xlabel={$x$}]
	\addplot[blue!90!red,domain=0:1,samples=201]{bump(x,0.4,0.6,0.6};
	\end{axis}
	\end{tikzpicture}
	\begin{tikzpicture}[declare function = {bump(\x,\s,\t,\h)=0.5*\h*(sign(\x-\s)-sign(\x-\t));}]
		\begin{axis}[width=0.32\linewidth,height=0.3\linewidth,align=center,title={Weighted output\\$s_1=0.2,s_2=0.5,h=-0.9$},axis x line=middle,axis y line=middle,xtick={0,1},ytick={-1,0,1},xmax=1.25,ymax=1.25,ymin=-1.25,xlabel={$x$}]
		\addplot[blue!90!red,domain=0:1,samples=201]{bump(x,0.2,0.5,-0.9};
		\end{axis}
	\end{tikzpicture}
\end{center}
...
\begin{center}
	...
	\begin{axis}[width=0.32\linewidth,height=0.4\linewidth,align=center,title={Weighted output\\$s_1=0.4,s_2=0.6,h_1=-1.2$\\$s_1=0.7,s_2=0.9,h_2=0.3$},axis x line=bottom,axis y line=left,xtick={0,1},ytick={-1,0,1},xmax=1.15,ymax=1.25,ymin=-1.25]
	\addplot[blue!90!red,domain=0:1,samples=201]{twobumps(x,0.4,0.6,-1.2,0.7,0.9,0.3};
	\end{axis}
	\end{tikzpicture}
	\begin{tikzpicture}[declare function = {step(\x,\s,\t)=0.5*(sign(\x-\s)-sign(\x-\t));twobumps(\x,\s,\t,\h,\ss,\tt,\hh) = \h*step(\x,\s,\t)+\hh*step(\x,\ss,\tt); }]
	\begin{axis}[width=0.32\linewidth,height=0.4\linewidth,align=center,title={Weighted output\\$s_1=0.2,s_2=0.5,h_1=0.75$\\$s_1=0.7,s_2=0.95,h_2=-0.9$},axis x line=bottom,axis y line=left,xtick={0,1},ytick={-1,0,1},xmax=1.15,ymax=1.25,ymin=-1.25]
